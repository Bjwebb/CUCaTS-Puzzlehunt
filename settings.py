...
HUNT = {
    ...
    'end': datetime.datetime(2012, 06, 17, 03, 30, 00)
}
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hunt',                      # Or path to database file if using sqlite3.
        'USER': 'hunt',                      # Not used with sqlite3.
        'PASSWORD': secret.PASSWORD,                  # Not used with sqlite3.
