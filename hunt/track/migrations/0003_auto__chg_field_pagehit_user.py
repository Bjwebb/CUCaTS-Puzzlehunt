...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageHit.user'
        db.alter_column(u'track_pagehit', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PageHit.user'
        raise RuntimeError("Cannot reverse this migration. 'PageHit.user' and its values cannot be restored.")
