...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageHit.team'
        db.add_column(u'track_pagehit', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Team'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageHit.team'
        db.delete_column(u'track_pagehit', 'team_id')
