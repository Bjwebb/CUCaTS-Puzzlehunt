...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'track_pagehit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'track', ['PageHit'])

        # Adding model 'Event'
        db.create_table(u'track_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pagehit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['track.PageHit'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal(u'track', ['Event'])


    def backwards(self, orm):
        # Deleting model 'PageHit'
        db.delete_table(u'track_pagehit')

        # Deleting model 'Event'
        db.delete_table(u'track_event')
