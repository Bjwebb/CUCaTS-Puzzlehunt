...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field nodes_visible on 'Team'
        db.create_table(u'main_team_nodes_visible', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm[u'main.team'], null=False)),
            ('node', models.ForeignKey(orm[u'main.node'], null=False))
        ))
        db.create_unique(u'main_team_nodes_visible', ['team_id', 'node_id'])

        # Deleting field 'Puzzle.fromnode'
        db.delete_column(u'main_puzzle', 'fromnode')

        # Deleting field 'Puzzle.tonode'
        db.delete_column(u'main_puzzle', 'tonode')

        # Adding field 'Puzzle.node'
        db.add_column(u'main_puzzle', 'node',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Node'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field nodes_visible on 'Team'
        db.delete_table('main_team_nodes_visible')

        # Adding field 'Puzzle.fromnode'
        db.add_column(u'main_puzzle', 'fromnode',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Puzzle.tonode'
        db.add_column(u'main_puzzle', 'tonode',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Puzzle.node'
        db.delete_column(u'main_puzzle', 'node_id')
