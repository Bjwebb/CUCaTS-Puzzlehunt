...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Puzzle.function'
        db.alter_column(u'main_puzzle', 'function', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Puzzle.function'
        db.alter_column(u'main_puzzle', 'function', self.gf('django.db.models.fields.CharField')(max_length=256))
