...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Puzzle.show_solution_box'
        db.add_column(u'main_puzzle', 'show_solution_box',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Puzzle.show_solution_box'
        db.delete_column(u'main_puzzle', 'show_solution_box')
