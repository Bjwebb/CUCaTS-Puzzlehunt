...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Puzzle.clue'
        db.delete_column(u'main_puzzle', 'clue')

        # Adding field 'Puzzle.quotes'
        db.add_column(u'main_puzzle', 'quotes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Puzzle.nodes'
        db.add_column(u'main_puzzle', 'nodes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Puzzle.clue'
        db.add_column(u'main_puzzle', 'clue',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Puzzle.quotes'
        db.delete_column(u'main_puzzle', 'quotes')

        # Deleting field 'Puzzle.nodes'
        db.delete_column(u'main_puzzle', 'nodes')
